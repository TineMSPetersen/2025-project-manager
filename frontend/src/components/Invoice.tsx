...
const Invoice = ({ commissionType, typePrice, characterAmount, addCharaterPrice, feePrices }: InvoiceProps) => {
  ...
  return (
    <div className="min-h-screen p-8 flex flex-col items-center ">
          ...
          <table className="w-full mb-8 border-collapse text-black">
            ...
            <tbody>
              <tr>
                ...
                <td className="border p-2 text-right">{typePrice + (characterAmount - 1) * addCharaterPrice}</td>
                <td className="border p-2 text-right">{feePrices.reduce((acc, val) => acc + val, 0)}</td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="mt-6 flex justify-center">
          <button
            className="bg-linear-to-b from-[#FF0036] to-[#321234] p-2 rounded-md outline-2 outline-[#FF0036] w-80 cursor-pointer"
          >
            Download PDF
          </button>
        </div>
